...
interface ActionScope<S : State, A : Action, E : Event, S2 : S> : StoreScope {
     ...
     * @param overlap The launch overlap setting used when the same key is launched repeatedly.
     * @param block The suspending block of code to execute
     */
    fun launch(coroutineDispatcher: CoroutineDispatcher = Dispatchers.Unconfined, key: Any? = null, overlap: LaunchOverlap = LaunchOverlap.ALLOW, block: suspend LaunchScope<S, A, E, S2>.() -> Unit)
