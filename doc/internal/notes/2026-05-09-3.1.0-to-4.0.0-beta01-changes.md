...
- `Middleware<S, A, E>` / `MiddlewareScope<A>` 削除。`Plugin<S, A, E>` / `PluginScope<S, A>` に置換。
  - 関連: `koma-core/src/commonMain/kotlin/io/github/komakt/koma/core/Plugin.kt`、`PluginScope.kt`
...
公開 API は 2 ファイル: `koma-test/src/commonMain/kotlin/io/github/komakt/koma/test/StoreExtensions.kt`、`StoreRecorder.kt`。
...
中核: `koma-core/src/commonMain/kotlin/io/github/komakt/koma/core/Plugin.kt`、`PluginScope.kt`。
